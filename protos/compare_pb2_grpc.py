...
class ComparisonServiceStub(object):
...
class ComparisonServiceServicer(object):
    """Missing associated documentation comment in .proto file."""
...
def add_ComparisonServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
